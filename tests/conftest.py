...
def fixture_device_map(request):
    ...
    yield request.config.target_config.device_map()
...
def fixture_board_access_for_fixture(board_access) -> BoardShell:
    ...
    This proides the special variant of cli.Shell that has one additional method reconnect(). It allows you to request
    the new instance and that way replace the existing one.
    """
    yield BoardShell(board_access)
